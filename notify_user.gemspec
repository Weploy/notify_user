...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<apnotic>, ["~> 1.4"])
      s.add_runtime_dependency(%q<connection_pool>, [">= 0"])
      s.add_runtime_dependency(%q<fcm>, [">= 0"])
      ...
      s.add_development_dependency(%q<bootsnap>, [">= 0"])
    else
      ...
      s.add_dependency(%q<apnotic>, ["~> 1.4"])
      s.add_dependency(%q<connection_pool>, [">= 0"])
      s.add_dependency(%q<fcm>, [">= 0"])
